                        ...
                        return (
                            ...
                            >
                                <Link href={`/services/${s.slug}`} style={{ textDecoration: 'none' }}>
                                    <div style={{ 
                                        padding: '80px 60px', background: '#05060f', height: '100%',
                                    ...
                                    onMouseLeave={e => {
                                        (e.currentTarget as HTMLElement).style.background = '#05060f';
                                    }}
                                    >
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 60 }}>
                                            <div style={{ padding: 15, background: 'rgba(255,255,255,0.03)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
                                                <Icon size={24} style={{ color: '#8B5CF6' }} />
                                            </div>
                                            <span className="font-cyber" style={{ fontSize: 9, opacity: 0.2 }}>SYS_0{i+1}</span>
                                        </div>

                                        <h3 style={{ fontSize: 26, fontWeight: 800, color: 'white', marginBottom: 20 }}>{s.title}</h3>
