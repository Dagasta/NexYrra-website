...
export default function AboutPage() {
    return (
        <main style={{ background: '#020203', minHeight: '100vh', color: 'white' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 120 }} className="grid-mobile-1">
                        <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 15, marginBottom: 40 }}>
                                 ...
                                 <span className="mono" style={{ color: '#A855F7' }}>// NEXYRRA_NEURAL_MANIFESTO_v5</span>
                            </div>
                            <h1 className="glow-text" style={{ fontSize: 'clamp(50px, 10vw, 150px)', lineHeight: 0.85, letterSpacing: '-0.07em', marginBottom: 60 }}>
                                BEYOND <br />
                                <span style={{ color: '#A855F7' }}>THE VOID.</span>
                            </h1>
                            <p style={{ fontSize: 20, color: '#94A3B8', lineHeight: 1.8, maxWidth: 520, fontWeight: 300 }}>
                            ...
                            <div className="glass-panel" style={{ padding: '60px', borderRadius: 0 }}>
                                ...
                                {[
                                    ...
                                    <div key={i} style={{ marginBottom: 30, borderBottom: '1px solid rgba(255,255,255,0.02)', paddingBottom: 15 }}>
                                        ...
                                        <div style={{ fontSize: 24, fontWeight: 800, color: 'white' }}>{m.v}</div>
                                    </div>
                                ))}
                            </div>
                        </div>
            ...
            <section style={{ padding: '240px 0', background: '#020203' }}>
                <div className="container-nex">
                    <div style={{ textAlign: 'center', marginBottom: 120 }}>
                        <div className="mono" style={{ letterSpacing: '1em', color: '#A855F7', marginBottom: 20 }}>CORE_DIRECTIVES</div>
                        <h2 className="glow-text" style={{ fontSize: 80, fontWeight: 900, letterSpacing: '-0.06em' }}>THE SYSTEMS CODE.</h2>
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 30 }} className="grid-mobile-1">
                        {directives.map((d, i) => (
                            ...
                            >
                                ...
                                <h3 style={{ fontSize: 20, fontWeight: 800, color: 'white', marginBottom: 20 }}>{d.title}</h3>
            ...
            <section style={{ padding: '240px 0', position: 'relative' }}>
                <div className="container-nex">
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 120 }} className="grid-mobile-1">
                        <div>
                            <div className="mono" style={{ color: '#A855F7', marginBottom: 20 }}>NEURAL_LEADERSHIP</div>
                        ...
                        <div style={{ display: 'flex', gap: 80, flexWrap: 'wrap' }}>
                            {[
                                ...
                                <div key={i} style={{ maxWidth: 320 }}>
                                    <div className="mono" style={{ fontSize: 9, color: '#A855F7', marginBottom: 15 }}>{m.role}</div>
