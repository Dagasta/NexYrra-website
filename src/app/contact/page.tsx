                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 140 }} className="grid-mobile-1">
                        ...
                        <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 15, marginBottom: 40 }}>
                                 ...
                                 <span className="mono" style={{ color: '#A855F7' }}>// UPLINK_INITIATION_PROTOCOL</span>
                            </div>
                            <h1 className="glow-text" style={{ fontSize: 'clamp(50px, 12vw, 140px)', lineHeight: 0.85, letterSpacing: '-0.07em', marginBottom: 60 }}>
                                SECURE <br />
                                <span style={{ color: '#A855F7' }}>UPLINK.</span>
                            </h1>
                            <p style={{ fontSize: 22, color: '#94A3B8', lineHeight: 1.8, maxWidth: 500, marginBottom: 120, fontWeight: 300 }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 60 }}>
                                {[
                                    ...
                                    <div key={i} style={{ display: 'flex', gap: 30, alignItems: 'center' }}>
                                        <div style={{ padding: 20, background: 'rgba(168, 85, 247, 0.05)', border: '1px solid rgba(168, 85, 247, 0.1)' }}>
                        ...
                        {/* Neural Entry Portal */}
                        <div className="glass-panel" style={{ padding: '80px', borderRadius: 0 }}>
                            <AnimatePresence mode="wait">
                                {status === 'success' ? (
                                    ...
                                    <motion.form key="form" onSubmit={handleSubmit} layout style={{ display: 'grid', gap: 60 }}>
                                        ...
                                        <div style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: 15 }}>
                                            <label className="mono" style={{ fontSize: 8, display: 'block', marginBottom: 15 }}>SYSTEM_CONSTRAINTS</label>
                                        ...
                                        <button type="submit" className="btn-neon" disabled={status === 'loading'} style={{ justifyContent: 'center' }}>
